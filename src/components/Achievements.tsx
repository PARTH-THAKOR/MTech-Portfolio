            ...
            {achievements.map((item, idx) => {
              return (
                <div key={idx} className="flex lg:flex-col gap-6 lg:gap-0 relative group h-full justify-between">
                  ...
                  <div className="flex-grow flex flex-col justify-between p-6 rounded-2xl bg-slate-950/55 backdrop-blur-xl glow-card border border-transparent group-hover:border-slate-800/60 relative z-10 transition-all duration-300">
